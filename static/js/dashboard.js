//****************************************************************************
// dashboard containing barchart and pie chart
//Source: http://bl.ocks.org/NPashaP/96447623ef4d342ee09b
//Purpose: to understand the usage of dashboard containing barchart and pie chart together and how to call it in Html.
//****************************************************************************
function dashboard(id, fData, wineName){
    ...
    function histoGram(fD){
        ...
        var hGsvg = d3.select(id).append("svg")
            ...
            .attr("height", hGDim.h + hGDim.t + hGDim.b + 10).append("g")
            .attr("transform", "translate(" + hGDim.l+40 + "," + hGDim.t + ")");
